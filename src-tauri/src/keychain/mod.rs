...
/// Get the TTS API key from secure storage
...
/// Set the TTS API key in secure storage
...
/// Delete the TTS API key from secure storage
...
/// Check if a TTS API key is configured
